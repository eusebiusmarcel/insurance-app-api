class V1::AdminPoliciesController < ApplicationController
  ...
  def created_policies
    ...
    User.find_by(email: params[:user_email].downcase)
    render json: { created_policies: Policy.created_policies.as_json(except: %i[policy_number User.user_email insured_item item_description insurance_type premium_per_month payment_per_month]),
