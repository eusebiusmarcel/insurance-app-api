class V1::AdminPoliciesController < ApplicationController
  ...
  def created_policies
    ...
    render json: { created_policies: Policy.created_policies.as_json(except: %i[policy_number user_id insured_item item_description insurance_type premium_per_month payment_per_month]),
